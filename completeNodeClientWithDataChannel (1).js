...
function sendData() {
  ...
  document.getElementById("chat").innerHTML += '<p>' + nameUser + ': ' + sendTextarea.value +'</p>';
...
function handleMessage(event) {
  ...
  console.log('event:USER ' + event.username2) ;
  document.getElementById("chat").innerHTML += '<p>' + 'Friend' + ': ' + receiveTextarea.value +'</p>';

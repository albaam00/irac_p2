...
document.getElementById("room").innerHTML='Join room ' + room;
var nameUser = prompt('Whats you name?');
console.log('name', nameUser);
document.getElementById("username").innerHTML=nameUser;
document.getElementById("username2").innerHTML='Friend';
...
function sendData() {
  ...
  var username2 = nameUser;
  document.getElementById("chat").innerHTML += '<p><b style= `color: red`>' + nameUser + ': </b>' + sendTextarea.value +'</p>';
  if(isInitiator) sendChannel.send(data, username2);
  else receiveChannel.send(data, username2);
...
function handleMessage(event) {
  ...
  document.getElementById("chat").innerHTML += '<p>' + '<b style= `color: blue`> Friend' + ': </b>' + receiveTextarea.value +'</p>';
